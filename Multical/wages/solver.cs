...
namespace wages
{
    class solver
    {
        public static void conv_to(TextBox ans, TextBox num, int _base)
        {
            if(num.Text == "")
            {
                num.Text = "0";
        ...
        public static void conv_to_hex(TextBox ans, TextBox num, int _base)
        {
            if (num.Text == "")
            {
                num.Text = "0";
        ...
        public static void conv_from(TextBox ans, TextBox num, int _base)
        {
            if (num.Text == "")
            {
                num.Text = "0";
        ...
        public static void conv_from_hex(TextBox ans, TextBox num, int _base)
        {
            if (num.Text == "")
            {
                num.Text = "0";
